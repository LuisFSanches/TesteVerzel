...
export default function AddTask() {
  ...
  const onSubmit = (e)=>{
    ...
    const newFormatDateConclusion= conclusion_date.split('-').reverse().join('-')
    const newTask = {
      id,
      user_id,
      name,
      ...
      <form action="" onSubmit = {onSubmit}>
        <div className="input-data">
          <div className="field-task">
            ...
            <input type="text" required placeholder = "Nome" value={name}
          onChange={(e) => setName(e.target.value)}/>
          </div>
          <div className="field-task">
            <label htmlFor="">Data de Entrega</label>
            <input type="date" required placeholder = "dd-mm-yyyy" value={delivery_date}
          onChange={(e) => setDeliveryDate(e.target.value)}/>
          </div>
          <div className="field-task">
            <label htmlFor="">Data de Conclusão</label>
            <input type="date" placeholder = "Data Conclusão" value={conclusion_date}
